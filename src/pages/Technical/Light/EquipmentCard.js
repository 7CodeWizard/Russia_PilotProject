  ...
  return (
    <div className="sectionWrapper pendingSquare section1">
      <div className="flexWrapBetween alignCenter">
        ...
        <p className="x30" style={{ color: `var(--secondaryWhiteHover)` }}>Чем мы можем помочь</p>
        <div className="chichaShow">
          <Link to="contactSection" spy={true} smooth={true}><BlackButton title='заказать консультацию' /></Link>
        </div>
      </div>
